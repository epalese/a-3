...
/**
 * Provide an implementation of {@link discoveryService.broker.Broker} based on TCP connection-oriented protocol.
 * <code>TCPReplyCapableBroker</code> is also able to manage replies.
 * For instance:
